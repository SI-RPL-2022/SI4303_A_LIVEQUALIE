        ...
        <div class="container-fluid">
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a id="p1" class="nav-link" aria-current="page" href="/">Home</a>
              </li>
              <li class="nav-item">
                <a id="p2" class="nav-link active" href="/artikel">Articles</a>
              </li>
              <li class="nav-item">
                <a id="p1" class="nav-link" href="#">Videos</a>
              </li>
              <li class="nav-item">
                <a id="p1" class="nav-link" href="/forum">Forum</a>
              </li>
              <li class="nav-item">
          ...
          <div class="w-100" style="margin: auto;">
            ...
            <div class="row" style="margin-top: 6rem;">
              <div class="col-4 px-2" style="padding: 0%;" >
                <img src="/Articles/1.jpeg" class="card-img-top w-110" alt="image" style="height:14rem;">
                <div class="card-body">
                  ...
                  <p class="card-text" style="height: 130px;overflow-y:hidden;">
                    ...
                    <a class="btn btn-outline-purple w-50 float-right" style="background-color:#ffffff; color:#D074D8; border-color: #D074D8;" href="DetailArtikel.html" role="button"> Baca Artikel </a>
                  </div>
              </div>

              <div class="col-4 px-2" style="padding: 0%;">
                <img src="/Articles/2.jpeg" class="card-img-top w-100" alt="image" style="height:14rem;">
                <div class="card-body " >
              ...
              <div class="col-4 px-4" style="padding: 0%;" >
                <div class="card-body ">
                  ...
                  <p class="card-text" style="height:110px;overflow-y:hidden;">
                    Saat ini,di DPR sedang gencar-gencarnya dibahas RUU Kesetaraan dan Keadilan Gender. <br/>
                    <a href="DetailArtikel.html" style="color: #D074D8;">Baca dalam 1 menit</a>
                    <br>
                  
                    <h5 class="card-text">Ketidakadilan Gender & Kekerasan Terhadap Perempuan Vol.II</h5>
                  <p class="card-text" style="height:110px;overflow-y:hidden;">
                    “ Setiap pembedaan, pengucilan, atau pembatasan yang dibuat atas dasar jenis kelamin <br/>
                    <a href="DetailArtikel.html" style="color: #D074D8;">Baca dalam 1 menit</a>
                    <br>
                  ...
                  <p class="card-text" style="height:100px;overflow-y:hidden;">
                    Pemerintah Indonesia menegaskan komitmen mendukung kesetaraan gender <br/>
                    <a href="DetailArtikel.html" style="color: #D074D8;">Baca dalam 1 menit</a>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <h5 class="text p-3"> Alasan dibalik Kesetaraan Gender</h5> 
              <a class="btn" style="background-color:#ffffff; color:#D074D8; border-color: #D074D8; width: 10rem; height: 2rem; font-size: 14px; margin-left: -200px; margin-top: 15px;" href="SemuaArtikel.html" role="button">Lihat Semua Artikel</a>
              <div class="col-3 px-2" style="padding: 0%" >
                <img src="/Articles/3.jpeg" class="card-img-top w-100" alt="image" style="height:12rem;">
                <div class="card-body">
                  <h5 class="card-text"><a href="DetailArtikel.html" style="text-decoration:none; color: black;">Perempuan Dan Teriakannya Seputar Kesetaraan Gender</a></h5>
                  <p class="card-text" style="height: 130px;overflow-y:hidden;">
                    Jargon “Kesetaraan Gender” sering digemakan oleh para aktivis sosial, kaum perempuan hingga para politikus Indonesia. </p>
                  </div>
                </div>
              ...
              <div class="col-3 px-2" style="padding: 0%" >
                <img src="/Articles/4.jpeg" class="card-img-top w-100" alt="image" style="height:12rem;">
                <div class="card-body">
                    <h5 class="card-text"><a href="DetailArtikel.html" style="text-decoration:none; color: black;">Perempuan Dan Teriakannya Seputar Kesetaraan Gender</a></h5>
                    <p class="card-text" style="height: 130px;overflow-y:hidden;">
                    Jargon “Kesetaraan Gender” sering digemakan oleh para aktivis sosial, kaum perempuan hingga para politikus Indonesia. </p>
              ...
              <div class="col-3 px-2" style="padding: 0%" >
                <img src="/Articles/5.jpeg" class="card-img-top w-100" alt="image" style="height:12rem;">
                <div class="card-body">
                    <h5 class="card-text"><a href="DetailArtikel.html" style="text-decoration:none; color: black;">Perempuan Dan Teriakannya Seputar Kesetaraan Gender</a></h5>
                    <p class="card-text" style="height: 130px;overflow-y:hidden;">
                      Jargon “Kesetaraan Gender” sering digemakan oleh para aktivis sosial, kaum perempuan hingga para politikus Indonesia. </p>
                  ...
                  <div class="col-3 px-2" style="padding: 0%" >
                    <img src="/Articles/6.jpeg" class="card-img-top w-100" alt="image" style="height:12rem;">
                    <div class="card-body">
                        <h5 class="card-text"><a href="DetailArtikel.html" style="text-decoration:none; color: black;">Perempuan Dan Teriakannya Seputar Kesetaraan Gender</a></h5>
                        <p class="card-text" style="height: 130px;overflow-y:hidden;">
                          Jargon “Kesetaraan Gender” sering digemakan oleh para aktivis sosial, kaum perempuan hingga para politikus Indonesia. </p>
