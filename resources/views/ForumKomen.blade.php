...
<body>
  ...
  <div class="container">
    <br> <br> <br>
    <h1 id="p" style="margin-top: 75px; margin-left: 30px;">FORUM</h1>
  </div>
          ...
          <div class="card-body" style="background-color: #ffffff; box-shadow: 1px 1px 4px 4px rgb(219, 217, 217); border-radius: 5px;">
            <div class="col" style="color: black;">
              ...
              <div class="card-text d-md-flex justify-content-md-end" style="color: red;">
                <a class="button4">Report</a>
              </div>
              <hr size="4px" style="color: black;">
              <span style="font-size: small;" class="card-subtitle mb-0">250</span>
              <span style="font-size: small; color: #BA68C8;" class="card-subtitle mb-0">Reply </span>
              <br>
              <br>
              <div class="form-control me-2" style="background-color: #FCEEE1;">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" class="me-2" style="margin-top: 8px;" viewBox="0 0 512 512">
                  <path d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 128c39.77 0 72 32.24 72 72S295.8 272 256 272c-39.76 0-72-32.24-72-72S216.2 128 256 128zM256 448c-52.93 0-100.9-21.53-135.7-56.29C136.5 349.9 176.5 320 224 320h64c47.54 0 87.54 29.88 103.7 71.71C356.9 426.5 308.9 448 256 448z" />
                </svg>
                <h7 style="margin-top: 20px;"><b> Tergantung penilaiannya subjektif atau objektif</b></h7>
                <p class="card-text text-muted text-end"><span style="font-size: smaller;">Replied <strong>3 Years</strong> ago by <strong>Hilal</strong></span></p>
              </div><br><br><br><br>
            </div>
          </div>
        </div>
  ...
  <form action="/komentar" method="post" enctype="multipart/form-data">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10 col-lg-offset-10" style="margin-top: 10px;">
        <div class="card h-100">
          <div class="card-body" style="background-color: #ffffff; box-shadow: 2px 2px 2px 2px rgb(219, 217, 217); border-radius: 0px;">
            <div class="form-group">
              <p class="card-text text-muted"> Add a reply . . .</p>
              <input required type="text" name="here" class="form-control form-control-sm" placeholder="here" aria-describedby="helpId"> <br>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10 col-lg-offset-10" style="margin-top: 0px; margin-bottom: 50px;">
        <div class="card h-80">
          <div class="card-body d-grid gap-2 d-md-flex justify-content-md-end" style="background-color: #E3E3E3; box-shadow: 2px 2px 2px 2px rgb(219, 217, 217); border-radius: 2px;">
